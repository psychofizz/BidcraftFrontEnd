        ...
        <div className="w-full shadow-lg  bg-bidcraft-dark rounded-lg">
            <div className="m-2">
                ...
                <div className="flex gap-2 px-2 mb-8">
                    <button className=" hidden flex-1 rounded-full bg-yellow-500  text-black antialiased font-bold hover:bg-blue-800 dark:hover:bg-blue-900 px-4 py-2 transition duration-300">
                        Perfil
                    </button>
