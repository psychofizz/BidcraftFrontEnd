...
const obtenProducto = async (token) => {
  try {
    const response = await fetch("http://127.0.0.1:8000/api/auction/show/all/", {
      method: "GET",
      headers: {
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="grid grid-cols-2 m-2 p-2 shadow-2 space-x-1 space-y-1">
