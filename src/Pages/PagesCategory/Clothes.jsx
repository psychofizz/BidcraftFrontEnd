...
const Clothes = () => {
  ...
  const [clothesAuction, setClothesAuction] = useState([]);

  useEffect(() => {
    fetch("http://127.0.0.1:8000/api/categories/show/all/")
      .then((response) => response.json())
      .then((data) => setClothesAuction(data))
...
//-----------Esto sirve solo para generar productos aleatorios-------------
  ...
  for (let i = 1; i <= 10; i++) {
    ...
    clothesAuction.push(producto);
  }


//-----------Esto sirve solo para generar productos aleatorios-------------

  console.log(clothesAuction);
