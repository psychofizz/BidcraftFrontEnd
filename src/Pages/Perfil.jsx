...
<div className="w-full ">
      <div className="flex border-t border-gray-300">
        <button
          className={`w-1/2 py-4 text-center font-medium text-gray-700  focus:outline-none  ${
            activeTab === 'tab1' ? 'border-ffc327 border-b-4 transition ease-in-out delay-100' : ''
          }`}
        ...
        <button
          className={`w-1/2 py-4 text-center font-medium text-gray-700  focus:outline-none  ${
            activeTab === 'tab2' ? 'border-ffc327 border-b-4 transition ease-in-out delay-100 ' : ''
          }`}
        ...
        <button
          className={`w-1/2 py-4 text-center font-medium text-gray-700  focus:outline-none  ${
            activeTab === 'tab3' ? 'border-ffc327 border-b-4 transition ease-in-out delay-100' : ''
          }`}
      ...
      <div
        id="tab1"
        className={`tabcontent transition-opacity duration-200 ease-in-out ${
          activeTab === 'tab1' ? 'opacity-100' : 'w-0 h-0  opacity-0 pointer-events-none'
        }`}
      >
 ...
 <div className={` flex flex-col sm:flex-row shadow-2xl overflow-hidden py-1 px-1 w-full text-center sm:text-left ${
          activeTab === 'tab2' ? 'mt-10' : 'mt-0'
        }`}>
